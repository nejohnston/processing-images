...
#     assert sepia == False
    ...
    for row in range(height):
        for col in range(width):
            if sepia == False:
                pixel = image[row][col]
                greyscale =  0.3 * pixel.red + 0.6 * pixel.green + 0.1 * pixel.blue
                red = int(0.3 * pixel.red + 0.6 * pixel.green + 0.1 * pixel.blue)
                blue = int(0.3 * pixel.red + 0.6 * pixel.green + 0.1 * pixel.blue)
                green = int(0.3 * pixel.red + 0.6 * pixel.green + 0.1 * pixel.blue)
                pixel.red = red
                pixel.blue = blue
                pixel.green = green
            else:
                sep = int(0.3 * pixel.red + 0.6 * pixel.brightness + 0.4 * pixel.brightness)
    return False
